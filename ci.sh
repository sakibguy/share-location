...
git config --global user.email "pavelgfn@gmail.com"
git config --global user.name "pavelgfn"
...
git remote set-url origin https://github.com/pavelgfn/share-location
############
# Step: 07 #
############
...
git push --all -f https://github.com/pavelgfn/share-location