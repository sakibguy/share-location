...
//                DisplayActivity.lhmReceivedFriendRequests.put(keyValue.key, tempKeyValue);
    ...
    // TESTING: SEND AUTO PUSH NOTIFICATION
    ...
    private void notifyUnfriend(String receiverUID) {
        databaseReference
                .child(receiverUID)
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot != null) {
                            if (dataSnapshot.hasChild("deviceToken")) {
                                ...
                                unfriendPushNotification(TARGET_DEVICE_TOKEN);
                            }
                        }
                    }
    ...
    private void unfriendPushNotification(String deviceToken) {
        try {
            JSONObject jsonObject = new JSONObject();
            JSONObject param = new JSONObject();
            param.put("body", "Unfriend");
            param.put("title", loggedInUserName + " unfriend you");
